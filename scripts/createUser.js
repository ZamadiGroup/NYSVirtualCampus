#!/usr/bin/env node
/**
 * Create a user directly in MongoDB for testing (admin/tutor/student).
 * Usage: node scripts/createUser.js <role> <email> <password> "Full Name"
 * Example: node scripts/createUser.js admin admin@example.com password "Admin User"
 */
...
if (!role || !email || !password) {
  console.error('Usage: node scripts/createUser.js <role> <email> <password> "Full Name"');
  process.exit(1);
}
